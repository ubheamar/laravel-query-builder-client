...
export class Query {
  ...
  protected idToFind: string | number | undefined;
  ...
  public getPageNumber(): number {
    let pageSpec = this.getPaginationSpec() as PageBasedPaginationSpec;
    return pageSpec.getPage();
  }
  ...
  public setPageSize(pageSize:number){
    this.getPaginationSpec().setPageLimit(pageSize);
  }
  public getPageSize():number{
    if(this.getPaginationSpec() instanceof PageBasedPaginationSpec){
      let pageSpec = <PageBasedPaginationSpec>this.getPaginationSpec();
      return pageSpec.getPageLimit();
    }
    return 0;
  }
  ...
  public setPageNumber(pageNumber:number){
    this.getPaginationSpec().setPage(pageNumber);
  }
...
/*
import {IQuery, KeyValuePair} from "@/types";

export class Query implements IQuery {
  public page: number = 1 ;
  public size: number = 10;
  public total: number = 0 ;
  public filters:KeyValuePair[]=[];
  public sorts:KeyValuePair[] = [];
}
*/
